...
for i=1:nbIter
        ...
        MapResBar    =    myClassify(TestBar,modelBar, modelSaumon, pBar, pSaumon, "B", "S");
        ResSaumon =    myClassify(TestSaumon,modelBar, modelSaumon, pBar, pSaumon, "B", "S");
        SaumonError = computeError(ResSaumon, "S");
        BarError = computeError(MapResBar, "B");
